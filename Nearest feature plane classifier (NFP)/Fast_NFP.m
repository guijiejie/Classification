function rate = Fast_NFP(Train_data,Train_label,Test_data,Test_label,ratio);
% Fast Nearest Feature Plane classifier(NFP classifier)
...
%This code is written by Gui Jie on the morning of 12/13/2012.
